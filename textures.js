...
window.saveTextureSettings = function() {
    ...
    function onLoad() {
        ...
        // Temporary until in-page-preview doesn't rely on this.
        Object.keys(imageData).forEach(function(key){
 ...
 */
window.getTextureImages = function(textures, callback) {
    var textureImages = {};
...
window.getDefaultTextures = function(callback) {
    var defaultTextures = {
        tiles: 'img/tiles.png',
