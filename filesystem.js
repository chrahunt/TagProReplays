 ...
 */
window.fsDeleteFile = function(path, callback, error) {
    getFileSystem(function(fs) {
 ...
 */
window.fsSaveFile = function(path, data, callback, error) {
    getFileSystem(function(fs) {
 ...
 */
window.fsGetFile = function(path, callback, error) {
    getFileSystem(function(fs) {
        fs.root.getFile(path, {}, function(fileEntry) {
 ...
 */
window.fsReadDirectory = function(path, callback, error) {
...
window.fsCreateDirectory = function(path, callback, error) {
    getDirectory(path, function(dirEntry) {
        callback();
    }, error);
};
