...
var logger = require('./modules/logger')('content');
...
if (document.URL.search(/\.\w+:/) >= 0) {
  ...
  DOMMessaging.listen('saveReplay', (data) => {
    logger.info('Received replay data from injected script, sending to background page.');
