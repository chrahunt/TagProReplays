...
exports.floor_tiles = {
  ...
  5.11: { tile: "previewspeedpad",   coordinates: [ { x: 0, y: 0 }, { x:  4, y: 0 } ], tileSize: 40, img: "speedpad", preview: true },
  ...
  6.11: { tile: "previewjukejuice",  coordinates: [ { x: 12, y: 4 }, { x: 12, y: 8 } ], tileSize: 40, img: "tiles", preview: true },
  6.21: { tile: "previewrollingbomb", coordinates: [ { x: 12, y: 5 }, { x: 12, y: 8 } ], tileSize: 40, img: "tiles", preview: true },
  6.31: { tile: "previewtagpro",     coordinates: [ { x: 12, y: 6 }, { x: 12, y: 8 } ], tileSize: 40, img: "tiles", preview: true },
  6.41: { tile: "previewspeed",      coordinates: [ { x: 12, y: 7 }, { x: 12, y: 8 } ], tileSize: 40, img: "tiles", preview: true },
  ...
  10.11: { tile: "previewbomb",      coordinates: [ { x: 12, y: 1 }, { x: 12, y: 2 } ], tileSize: 40, img: "tiles", preview: true },
  ...
  13.11: { tile: "previewportal",    coordinates: [ { x: 0, y: 0 }, { x:  4, y: 0 } ], tileSize: 40, img: "portal", preview: true },
  ...
  14.11: { tile: "previewspeedpadred",  coordinates: [ { x: 0, y: 0 }, { x:  4, y: 0 } ], tileSize: 40, img: "speedpadred", preview: true },
  ...
  15.11: { tile: "previewspeedpadblue", coordinates: [ { x: 0, y: 0 }, { x:  4, y: 0 } ], tileSize: 40, img: "speedpadblue", preview: true },
