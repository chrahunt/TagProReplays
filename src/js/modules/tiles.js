...
exports.mapElements = {
  ...
  6.11: {tile: "emptypowerup", coordinates: {x: 13, y: 4}, tileSize: 40, drawTileFirst: true},
  6.21: {tile: "emptypowerup", coordinates: {x: 13, y: 4}, tileSize: 40, drawTileFirst: true},
  6.31: {tile: "emptypowerup", coordinates: {x: 13, y: 4}, tileSize: 40, drawTileFirst: true},
  6.41: {tile: "emptypowerup", coordinates: {x: 13, y: 4}, tileSize: 40, drawTileFirst: true},
  6.12:  { tile: "emptyjukejuice", coordinates: { x: 12, y: 4 }, tileSize: 40, drawTileFirst: true },
  6.22:  { tile: "emptyrollingbomb", coordinates: { x: 12, y: 5 }, tileSize: 40, drawTileFirst: true },
  6.32:  { tile: "emptytagpro", coordinates: { x: 12, y: 6 }, tileSize: 40, drawTileFirst: true },
  6.42:  { tile: "emptyspeed", coordinates: { x: 12, y: 7 }, tileSize: 40, drawTileFirst: true },
...
exports.floor_tiles = {
  ...
  6.12: { tile: "emptyjukejuice",      coordinates: { x: 12, y: 8 }, tileSize: 40, img: "tiles" },
  6.22: { tile: "emptyrollingbomb",    coordinates: { x: 12, y: 8 }, tileSize: 40, img: "tiles" },
  6.32: { tile: "emptytagpro",         coordinates: { x: 12, y: 8 }, tileSize: 40, img: "tiles" },
  6.42: { tile: "emptypeed",           coordinates: { x: 12, y: 7 }, tileSize: 40, img: "tiles", emptyCoordinates: { x: 12, y: 8 } },
